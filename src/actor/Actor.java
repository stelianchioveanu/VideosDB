...
public class Actor {
    ...
    public double getActorRating(HashMap<String, Movie> movieHashMap, HashMap<String, Serial> serialHashMap) {
        double rating = 0;
        int nr = 0;
    ...
    public static String averageActor(Action action, HashMap<String, Movie> movieHashMap, HashMap<String, Serial> serialHashMap, HashMap<String, Actor> actorHashMap){
        ...
        sortedArray.sort((o1, o2) -> {
            if (Double.compare(o1.getActorRating(movieHashMap, serialHashMap), o2.getActorRating(movieHashMap, serialHashMap)) == 0){
                return o1.name.compareTo(o2.name);
            }
            return Double.compare(o1.getActorRating(movieHashMap, serialHashMap), o2.getActorRating(movieHashMap, serialHashMap));
        });
